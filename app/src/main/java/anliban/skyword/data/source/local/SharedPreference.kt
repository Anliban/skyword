...
private const val PREF_NAME = "local"

open class PreferenceModel(context: Context, name: String = PREF_NAME) {

    internal val pref: SharedPreferences = context.getSharedPreferences(name, Context.MODE_PRIVATE)

    protected fun stringPreference(key: String, default: String? = null) =
